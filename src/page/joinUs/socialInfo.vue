<template>
 <div class="recruitAll">
     ...
     <div class="styBanner">
        ...
        <div class="topNav">
            <el-breadcrumb separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item :to="{ path: '/joinUs/socialTalents' }">社会人才</el-breadcrumb-item>
    ...
    <!-- <div class="hideBanner" v-html="companyInfo[0].SliderBar"></div> -->
    <!-- 企业介绍 -->
    <div class="mainCont">
...
export default {
 ...
 methods: {
    ...
    getdata(){
        this.$axios.post('/api/Table/TableAction',{
            Action: "SearchBlurEnabled",
            DataJSONString: JSON.stringify({JobType:2,CompanyInfoID:this.$route.params.id}),
            Resource: "Job",
            PageControl: { PageSize:this.pageSize, PageIndex: this.page, OrderBy: "DisplayIndex DESC,ID DESC"}
        }).then((res)=>{
            this.companyData = JSON.parse(res.data).Rows;
 ...
 mounted(){
    ...
    this.$axios.post('/api/Table/TableAction',{
        ...
        DataJSONString: JSON.stringify({CommonInfoType:15}),
        Resource: "CommonInfo",
    ...
    this.$axios.post('/api/Table/TableAction',{
        ...
        document.title = this.companyName + '_社会人才招聘_加入我们' + '_上海隧道工程有限公司';
    }).catch((err)=>{
        throw err;
    })
 },
